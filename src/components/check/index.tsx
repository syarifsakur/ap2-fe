...
const Check: React.FC = () => {
  ...
  useEffect(() => {
    const fetchUnits = async () => {
      try {
        ...
        console.log("Fetched units:", response.data.response);
  ...
  const handleCategoryChange = (value: string) => {
    ...
    console.log("Filtered Units:", newFilteredUnits);
  ...
  return (
    <div>
      <section
        id="payment"
        className="py-10 md:py-20 bg-white flex flex-col items-center justify-center"
      >
        <div className="container mx-auto md:px-8 py-10">
          ...
          >
            <h2 className="text-xl font-semibold mb-4">Informasi Data Diri</h2>
            <Form.Item
              label="Nama"
              name="name"
            ...
            <h2 className="text-xl font-semibold mt-6 mb-4">Informasi Motor</h2>
            <Form.Item
